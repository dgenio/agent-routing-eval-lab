...
class ContextWeaverRouter:
    ...
    def route(self, query: str, intent: str, available_tools: list[str], metadata: dict | None = None) -> str:
        ...
        if intent == "refund_request" and "billing.issue_refund" in card_names and (metadata or {}).get("approval_granted"):
        ...
        return card_names[0] if card_names else available_tools[0]
